...
suite('Should get diagnostics', function () {
    var docUri = (0, helper_1.getDocUri)('diagnostics.txt');
    test('Diagnoses uppercase texts', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testDiagnostics(docUri, [
...
function toRange(sLine, sChar, eLine, eChar) {
    var start = new vscode.Position(sLine, sChar);
    var end = new vscode.Position(eLine, eChar);
