...
function activate(docUri) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ext = vscode.extensions.getExtension('vscode-samples.lsp-sample');
...
function setTestContent(content) {
    return __awaiter(this, void 0, void 0, function () {
        var all;
        return __generator(this, function (_a) {
            all = new vscode.Range(exports.doc.positionAt(0), exports.doc.positionAt(exports.doc.getText().length));
            return [2 /*return*/, exports.editor.edit(function (eb) { return eb.replace(all, content); })];
        });
    });
}
